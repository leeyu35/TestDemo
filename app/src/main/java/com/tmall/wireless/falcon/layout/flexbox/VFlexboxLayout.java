package com.tmall.wireless.falcon.layout.flexbox;
...
import com.libra.common.FlexboxLayoutCommon;
...
import static com.libra.common.FlexboxLayoutCommon.ALIGN_CONTENT_CENTER;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_CONTENT_FLEX_END;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_CONTENT_SPACE_AROUND;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_CONTENT_SPACE_BETWEEN;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_CONTENT_STRETCH;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_ITEMS_BASELINE;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_ITEMS_CENTER;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_ITEMS_FLEX_END;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_ITEMS_FLEX_START;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_ITEMS_STRETCH;
import static com.libra.common.FlexboxLayoutCommon.ALIGN_SELF_AUTO;
import static com.libra.common.FlexboxLayoutCommon.FLEX_DIRECTION_COLUMN;
import static com.libra.common.FlexboxLayoutCommon.FLEX_DIRECTION_COLUMN_REVERSE;
import static com.libra.common.FlexboxLayoutCommon.FLEX_DIRECTION_ROW;
import static com.libra.common.FlexboxLayoutCommon.FLEX_DIRECTION_ROW_REVERSE;
import static com.libra.common.FlexboxLayoutCommon.FLEX_WRAP_NOWRAP;
import static com.libra.common.FlexboxLayoutCommon.FLEX_WRAP_WRAP;
import static com.libra.common.FlexboxLayoutCommon.FLEX_WRAP_WRAP_REVERSE;
import static com.libra.common.FlexboxLayoutCommon.JUSTIFY_CONTENT_CENTER;
import static com.libra.common.FlexboxLayoutCommon.JUSTIFY_CONTENT_FLEX_END;
import static com.libra.common.FlexboxLayoutCommon.JUSTIFY_CONTENT_FLEX_START;
import static com.libra.common.FlexboxLayoutCommon.JUSTIFY_CONTENT_SPACE_AROUND;
import static com.libra.common.FlexboxLayoutCommon.JUSTIFY_CONTENT_SPACE_BETWEEN;
import static com.libra.common.StringTab.STR_ID_alignContent;
import static com.libra.common.StringTab.STR_ID_alignItems;
import static com.libra.common.StringTab.STR_ID_flexDirection;
import static com.libra.common.StringTab.STR_ID_flexWrap;
import static com.libra.common.StringTab.STR_ID_justifyContent;

/**
 * Created by gujicheng on 17/6/5.
 */

public class VFlexboxLayout extends VLayoutBase {

    @IntDef({FlexboxLayoutCommon.FLEX_DIRECTION_ROW, FLEX_DIRECTION_ROW_REVERSE, FLEX_DIRECTION_COLUMN,
...
//    public static final int FLEX_WRAP_WRAP_REVERSE = 2;
    ...
    @IntDef({FlexboxLayoutCommon.JUSTIFY_CONTENT_FLEX_START, JUSTIFY_CONTENT_FLEX_END, JUSTIFY_CONTENT_CENTER,
...
//    public static final int ALIGN_ITEMS_STRETCH = 4;
    ...
    @IntDef({FlexboxLayoutCommon.ALIGN_CONTENT_FLEX_START, ALIGN_CONTENT_FLEX_END, ALIGN_CONTENT_CENTER,
...
//    public static final int ALIGN_CONTENT_STRETCH = 5;
    ...
    public static class Builder implements IBuilder {
        ...
        public String getName() {
            return "VFlexboxLayout";
        }

        @Override
        public IView build(PageContext pageContext, ViewCache viewCache) {
            return new VFlexboxLayout(pageContext, viewCache);
        }
    }
    ...
    public boolean setIntValue(int key, int value) {
        ...
        switch (key) {
            case STR_ID_flexDirection:
                mFlexDirection = value;
                break;
            case STR_ID_flexWrap:
                mFlexWrap = value;
                break;
            case STR_ID_justifyContent:
                mJustifyContent = value;
                break;
            case STR_ID_alignItems:
                mAlignItems = value;
                break;
            case STR_ID_alignContent:
                mAlignContent = value;
                break;
            default:
    ...
    public VFlexboxLayout(PageContext pageContext, ViewCache viewCache) {
...
//        public static final int ALIGN_SELF_STRETCH = ALIGN_ITEMS_STRETCH;
        ...
        public boolean setIntValue(int key, int value) {
            ...
            switch (key) {
                case StringTab.STR_ID_layout_order:
                    order = value;
                    break;
                case StringTab.STR_ID_layout_flexGrow:
                    flexGrow = value;
                    break;
                case StringTab.STR_ID_layout_flexShrink:
                    flexShrink = value;
                    break;
                case StringTab.STR_ID_layout_alignSelf:
                    alignSelf = value;
                    break;
                case StringTab.STR_ID_layout_flexBasisPercent:
                    flexBasisPercent = value;
                    break;
                case StringTab.STR_ID_layout_minWidth:
                    minWidth = value;
                    break;
                case StringTab.STR_ID_layout_minHeight:
                    minHeight = value;
                    break;
                case StringTab.STR_ID_layout_maxWidth:
                    maxWidth = value;
                    break;
                case StringTab.STR_ID_layout_maxHeight:
                    maxHeight = value;
                    break;
                case StringTab.STR_ID_layout_wrapBefore:
                    wrapBefore = (value > 0) ? true : false;
                    break;
    ...
    public void onVMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mChildrenFrozen == null || mChildrenFrozen.length < mChildren.size()) {
            mChildrenFrozen = new boolean[mChildren.size()];
        }
     ...
     * returns {@code null}.
     */
    public IView getReorderedChildAt(int index) {
        if (index < 0 || index >= mReorderedIndices.length) {
            return null;
        }
        return mChildren.get(mReorderedIndices[index]);
    }

//    @Override
//    public void addView(IView child, int index, ViewGroup.LayoutParams params) {
...
//    }
    ...
    private List<Order> createOrders(int childCount) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            LayoutParams params = (LayoutParams) child.getVLayoutParams();
    ...
    private boolean isOrderChangedFromLastMeasurement() {
        ...
        for (int i = 0; i < childCount; i++) {
            IView view = mChildren.get(i);
            if (view == null) {
                continue;
            }
            LayoutParams lp = (LayoutParams) view.getVLayoutParams();
...
//            int paddingEnd = ViewCompat.getPaddingEnd(this);
            ...
            for (int i = 0; i < childCount; i++) {
                IView child = getReorderedChildAt(i);
                if (child == null) {
                ...
                LayoutParams lp = (LayoutParams) child.getVLayoutParams();
                if (lp.alignSelf == FlexboxLayoutCommon.ALIGN_SELF_STRETCH) {
                ...
                int childWidthMeasureSpec = getChildMeasureSpec(widthMeasureSpec,
                        getVPaddingLeft() + getVPaddingRight() + lp.leftMargin
                                + lp.rightMargin, childWidth);
                int childHeightMeasureSpec = getChildMeasureSpec(heightMeasureSpec,
                        getVPaddingTop() + getVPaddingBottom() + lp.topMargin
                ...
                if (isWrapRequired(widthMode, widthSize, flexLine.mMainSize,
                        child.getVMeasuredWidth() + lp.leftMargin + lp.rightMargin, lp,
                        i, indexInFlexLine)) {
                    ...
                    flexLine.mMainSize = paddingStart + paddingEnd;
                    largestHeightInRow = child.getVMeasuredHeight() + lp.topMargin + lp.bottomMargin;
                    indexInFlexLine = 0;
                } else {
                    flexLine.mItemCount++;
                    indexInFlexLine++;
                }
                flexLine.mMainSize += child.getVMeasuredWidth() + lp.leftMargin + lp.rightMargin;
                ...
                if (mFlexWrap != FLEX_WRAP_WRAP_REVERSE) {
                    flexLine.mMaxBaseline = Math
                            .max(flexLine.mMaxBaseline, lp.topMargin);
                } else {
        ...
        if (mAlignItems == ALIGN_ITEMS_BASELINE) {
            ...
            for (FlexLine flexLine : mFlexLines) {
                ...
                for (int i = viewIndex; i < viewIndex + flexLine.mItemCount; i++) {
                    ...
                    LayoutParams lp = (LayoutParams) child.getVLayoutParams();
                    if (mFlexWrap != FLEX_WRAP_WRAP_REVERSE) {
                        int marginTop = flexLine.mMaxBaseline - 0;
                        marginTop = Math.max(marginTop, lp.topMargin);
                        largestHeightInLine = Math.max(largestHeightInLine,
                                child.getVMeasuredHeight() + marginTop + lp.bottomMargin);
                    } else {
                        int marginBottom = flexLine.mMaxBaseline - child.getVMeasuredHeight() +
                                0;
                        marginBottom = Math.max(marginBottom, lp.bottomMargin);
                        largestHeightInLine = Math.max(largestHeightInLine,
                                child.getVMeasuredHeight() + lp.topMargin + marginBottom);
                    }
                }
        ...
        determineCrossSize(mFlexDirection, widthMeasureSpec, heightMeasureSpec,
                getVPaddingTop() + getVPaddingBottom());
    ...
    private void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // loop)
        int childCount = mChildren.size();
        int paddingTop = getVPaddingTop();
        int paddingBottom = getVPaddingBottom();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isWrapRequired(heightMode, heightSize, flexLine.mMainSize,
                    child.getVMeasuredHeight() + lp.topMargin + lp.bottomMargin, lp,
                    i, indexInFlexLine)) {
                if (flexLine.getItemCountNotGone() > 0) {
                    addFlexLine(flexLine, totalCrossSize);
                    totalCrossSize += flexLine.mCrossSize;
                ...
                flexLine.mItemCount = 1;
                flexLine.mMainSize = paddingTop + paddingBottom;
                largestWidthInColumn = child.getVMeasuredWidth() + lp.leftMargin + lp.rightMargin;
                indexInFlexLine = 0;
            } else {
                flexLine.mItemCount++;
                indexInFlexLine++;
            }
            flexLine.mMainSize += child.getVMeasuredHeight() + lp.topMargin + lp.bottomMargin;
            flexLine.mTotalFlexGrow += lp.flexGrow;
            flexLine.mTotalFlexShrink += lp.flexShrink;
        ...
        determineMainSize(mFlexDirection, widthMeasureSpec, heightMeasureSpec);
        determineCrossSize(mFlexDirection, widthMeasureSpec, heightMeasureSpec,
                getVPaddingLeft() + getVPaddingRight());
        // Now cross size for each flex line is determined.
        // Expand the views if alignItems (or alignSelf in each child view) is set to stretch
        stretchViews(mFlexDirection, mAlignItems);
        setMeasuredDimensionForFlex(mFlexDirection, widthMeasureSpec, heightMeasureSpec,
     ...
     */
    private void checkSizeConstraints(IView view) {
        boolean needsMeasure = false;
        LayoutParams lp = (LayoutParams) view.getVLayoutParams();
        int childWidth = view.getVMeasuredWidth();
        int childHeight = view.getVMeasuredHeight();

        if (view.getVMeasuredWidth() < lp.minWidth) {
            needsMeasure = true;
            childWidth = lp.minWidth;
        } else if (view.getVMeasuredWidth() > lp.maxWidth) {
            needsMeasure = true;
        ...
        if (needsMeasure) {
            view.vMeasure(View.MeasureSpec.makeMeasureSpec(childWidth, View.MeasureSpec.EXACTLY),
    ...
    private void determineMainSize(@FlexDirection int flexDirection, int widthMeasureSpec,
        ...
        switch (flexDirection) {
            ...
            case FLEX_DIRECTION_ROW_REVERSE:
                ...
                paddingAlongMainAxis = getVPaddingLeft() + getVPaddingRight();
                break;
            case FLEX_DIRECTION_COLUMN: // Intentional fall through
            case FLEX_DIRECTION_COLUMN_REVERSE:
                int heightMode = View.MeasureSpec.getMode(heightMeasureSpec);
                ...
                paddingAlongMainAxis = getVPaddingTop() + getVPaddingBottom();
                break;
            default:
    ...
    private int expandFlexItems(int widthMeasureSpec, int heightMeasureSpec, FlexLine flexLine,
        ...
        for (int i = 0; i < flexLine.mItemCount; i++) {
            IView child = getReorderedChildAt(childIndex);
            if (child == null) {
                continue;
            } else if (child.isGone()) {
                childIndex++;
            ...
            if (isMainAxisDirectionHorizontal(flexDirection)) {
                ...
                if (!mChildrenFrozen[childIndex]) {
                    float rawCalculatedWidth = child.getVMeasuredWidth() + unitSpace * lp.flexGrow;
                    ...
                    child.vMeasure(View.MeasureSpec.makeMeasureSpec(newWidth, View.MeasureSpec.EXACTLY),
                            childHeightMeasureSpec);
                    largestCrossSize = Math.max(largestCrossSize, child.getVMeasuredHeight()
                ...
                if (!mChildrenFrozen[childIndex]) {
                    float rawCalculatedHeight = child.getVMeasuredHeight() + unitSpace * lp.flexGrow;
                    if (i == flexLine.mItemCount - 1) {
                    ...
                    largestCrossSize = Math.max(largestCrossSize, child.getVMeasuredWidth()
    ...
    private int shrinkFlexItems(int widthMeasureSpec, int heightMeasureSpec, FlexLine flexLine,
        ...
        for (int i = 0; i < flexLine.mItemCount; i++) {
            ...
            if (isMainAxisDirectionHorizontal(flexDirection)) {
                ...
                if (!mChildrenFrozen[childIndex]) {
                    float rawCalculatedWidth = child.getVMeasuredWidth()
                ...
                if (!mChildrenFrozen[childIndex]) {
                    float rawCalculatedHeight = child.getVMeasuredHeight()
                            - unitShrink * lp.flexShrink;
                    if (i == flexLine.mItemCount - 1) {
                        rawCalculatedHeight += accumulatedRoundError;
                        accumulatedRoundError = 0;
    ...
    private int getChildWidthMeasureSpec(int widthMeasureSpec, LayoutParams lp, int padding) {
        ...
        if (childWidth > lp.maxWidth) {
            childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(lp.maxWidth,
                    View.MeasureSpec.getMode(childWidthMeasureSpec));
        } else if (childWidth < lp.minWidth) {
            childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(lp.minWidth,
                    View.MeasureSpec.getMode(childWidthMeasureSpec));
        }
    ...
    private int getChildHeightMeasureSpec(int heightMeasureSpec, LayoutParams lp, int padding) {
        ...
        if (childHeight > lp.maxHeight) {
            childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(lp.maxHeight,
                    View.MeasureSpec.getMode(childHeightMeasureSpec));
        } else if (childHeight < lp.minHeight) {
            childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(lp.minHeight,
                    View.MeasureSpec.getMode(childHeightMeasureSpec));
        }
        ...
        if (alignItems == ALIGN_ITEMS_STRETCH) {
            ...
            for (FlexLine flexLine : mFlexLines) {
                for (int i = 0; i < flexLine.mItemCount; i++, viewIndex++) {
                    IView view = getReorderedChildAt(viewIndex);
                    LayoutParams lp = (LayoutParams) view.getVLayoutParams();
                    if (lp.alignSelf != ALIGN_SELF_AUTO &&
                            lp.alignSelf != FlexboxLayoutCommon.ALIGN_SELF_STRETCH) {
                        continue;
                    }
                    switch (flexDirection) {
                        case FLEX_DIRECTION_ROW: // Intentional fall through
            ...
            for (FlexLine flexLine : mFlexLines) {
                for (Integer index : flexLine.mIndicesAlignSelfStretch) {
                    IView view = getReorderedChildAt(index);
                    switch (flexDirection) {
                        case FLEX_DIRECTION_ROW: // Intentional fall through
                        case FLEX_DIRECTION_ROW_REVERSE:
                            stretchViewVertically(view, flexLine.mCrossSize);
     ...
     */
    private void stretchViewVertically(IView view, int crossSize) {
        LayoutParams lp = (LayoutParams) view.getVLayoutParams();
        int newHeight = crossSize - lp.topMargin - lp.bottomMargin;
        newHeight = Math.max(newHeight, 0);
        view.vMeasure(View.MeasureSpec
                        .makeMeasureSpec(view.getVMeasuredWidth(), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(newHeight, View.MeasureSpec.EXACTLY));
    }
     ...
     * @param crossSize the cross size
     */
    private void stretchViewHorizontally(IView view, int crossSize) {
        LayoutParams lp = (LayoutParams) view.getVLayoutParams();
        int newWidth = crossSize - lp.leftMargin - lp.rightMargin;
        newWidth = Math.max(newWidth, 0);
        view.vMeasure(View.MeasureSpec
                        .makeMeasureSpec(newWidth, View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(view.getVMeasuredHeight(), View.MeasureSpec.EXACTLY));
    }
    ...
    private void setMeasuredDimensionForFlex(@FlexDirection int flexDirection, int widthMeasureSpec,
        ...
        switch (flexDirection) {
            case FLEX_DIRECTION_ROW: // Intentional fall through
            case FLEX_DIRECTION_ROW_REVERSE:
                calculatedMaxHeight = getSumOfCrossSize() + getVPaddingTop()
                        + getVPaddingBottom();
            ...
            case FLEX_DIRECTION_COLUMN_REVERSE:
                ...
                calculatedMaxWidth = getSumOfCrossSize() + getVPaddingLeft() + getVPaddingRight();
                break;
            default:
                throw new IllegalArgumentException("Invalid flex direction: " + flexDirection);
        }
        ...
        setVMeasuredDimension(widthSizeAndState, heightSizeAndState);
    }
    ...
    private void layoutHorizontal(boolean isRtl, int left, int top, int right, int bottom) {
        int paddingLeft = getVPaddingLeft();
        int paddingRight = getVPaddingRight();
        ...
        int childBottom = height - getVPaddingBottom();
        int childTop = getVPaddingTop();
        ...
        for (int i = 0, size = mFlexLines.size(); i < size; i++) {
            ...
            for (int j = 0; j < flexLine.mItemCount; j++) {
                IView child = getReorderedChildAt(currentViewIndex);
                if (child == null) {
                    continue;
                } else if (child.isGone()) {
                    currentViewIndex++;
                ...
                if (mFlexWrap == FLEX_WRAP_WRAP_REVERSE) {
                    if (isRtl) {
                        layoutSingleChildHorizontal(child, flexLine, mFlexWrap, mAlignItems,
                                Math.round(childRight) - child.getVMeasuredWidth(),
                                childBottom - child.getVMeasuredHeight(), Math.round(childRight),
                                childBottom);
                    } else {
                        layoutSingleChildHorizontal(child, flexLine, mFlexWrap, mAlignItems,
                                Math.round(childLeft), childBottom - child.getVMeasuredHeight(),
                                Math.round(childLeft) + child.getVMeasuredWidth(),
                                childBottom);
                    }
                } else {
                    if (isRtl) {
                        layoutSingleChildHorizontal(child, flexLine, mFlexWrap, mAlignItems,
                                Math.round(childRight) - child.getVMeasuredWidth(), childTop,
                                Math.round(childRight), childTop + child.getVMeasuredHeight());
                    } else {
                        layoutSingleChildHorizontal(child, flexLine, mFlexWrap, mAlignItems,
                ...
                childLeft += child.getVMeasuredWidth() + spaceBetweenItem + lp.rightMargin;
                childRight -= child.getVMeasuredWidth() + spaceBetweenItem + lp.leftMargin;
                currentViewIndex++;

                flexLine.mLeft = Math.min(flexLine.mLeft, child.getVLeft() - lp.leftMargin);
                flexLine.mTop = Math.min(flexLine.mTop, child.getVTop() - lp.topMargin);
                flexLine.mRight = Math.max(flexLine.mRight, child.getVLeft() + child.getVMeasuredWidth() + lp.rightMargin);
                flexLine.mBottom = Math.max(flexLine.mBottom, child.getVTop() + child.getVMeasuredHeight() + lp.bottomMargin);
            }
     ...
     * @see LayoutParams#alignSelf
     */
    private void layoutSingleChildHorizontal(IView view, FlexLine flexLine, @FlexWrap int flexWrap,
        ...
        switch (alignItems) {
            ...
            case ALIGN_ITEMS_STRETCH:
                if (flexWrap != FLEX_WRAP_WRAP_REVERSE) {
                    view.vLayout(left, top + lp.topMargin, right, bottom + lp.topMargin);
                } else {
                    view.vLayout(left, top - lp.bottomMargin, right, bottom - lp.bottomMargin);
                }
                break;
            case ALIGN_ITEMS_BASELINE:
                if (flexWrap != FLEX_WRAP_WRAP_REVERSE) {
                    int marginTop = flexLine.mMaxBaseline - 0;
                    marginTop = Math.max(marginTop, lp.topMargin);
                    view.vLayout(left, top + marginTop, right, bottom + marginTop);
                } else {
                    int marginBottom = flexLine.mMaxBaseline - view.getVMeasuredHeight() + 0;
                    marginBottom = Math.max(marginBottom, lp.bottomMargin);
                    view.vLayout(left, top - marginBottom, right, bottom - marginBottom);
                }
                break;
            case ALIGN_ITEMS_FLEX_END:
                if (flexWrap != FLEX_WRAP_WRAP_REVERSE) {
                    view.vLayout(left,
                            top + crossSize - view.getVMeasuredHeight() - lp.bottomMargin,
                    ...
                    view.vLayout(left, top - crossSize + view.getVMeasuredHeight() + lp.topMargin,
                            right, bottom - crossSize + view.getVMeasuredHeight() + lp.topMargin);
                }
                break;
            case ALIGN_ITEMS_CENTER:
                int topFromCrossAxis = (crossSize - view.getVMeasuredHeight()
                        + lp.topMargin - lp.bottomMargin) / 2;
                if (flexWrap != FLEX_WRAP_WRAP_REVERSE) {
                    view.vLayout(left, top + topFromCrossAxis,
                            right, top + topFromCrossAxis + view.getVMeasuredHeight());
                } else {
                    view.vLayout(left, top - topFromCrossAxis,
                            right, top - topFromCrossAxis + view.getVMeasuredHeight());
                }
                ...
                if (isRtl) {
                    if (fromBottomToTop) {
                        layoutSingleChildVertical(child, flexLine, true, mAlignItems,
                                childRight - child.getVMeasuredWidth(),
                                Math.round(childBottom) - child.getVMeasuredHeight(), childRight,
                                Math.round(childBottom));
                    } else {
                        layoutSingleChildVertical(child, flexLine, true, mAlignItems,
                                childRight - child.getVMeasuredWidth(), Math.round(childTop),
                                childRight, Math.round(childTop) + child.getVMeasuredHeight());
                    }
                } else {
                    if (fromBottomToTop) {
                        layoutSingleChildVertical(child, flexLine, false, mAlignItems,
                                childLeft, Math.round(childBottom) - child.getVMeasuredHeight(),
                                childLeft + child.getVMeasuredWidth(), Math.round(childBottom));
                    } else {
                        layoutSingleChildVertical(child, flexLine, false, mAlignItems,
                                childLeft, Math.round(childTop),
                                childLeft + child.getVMeasuredWidth(),
                                Math.round(childTop) + child.getVMeasuredHeight());
                    }
                }
                childTop += child.getVMeasuredHeight() + spaceBetweenItem + lp.bottomMargin;
                childBottom -= child.getVMeasuredHeight() + spaceBetweenItem + lp.topMargin;
                currentViewIndex++;
     ...
     * @see LayoutParams#alignSelf
     */
    private void layoutSingleChildVertical(IView view, FlexLine flexLine, boolean isRtl,
                                           int alignItems, int left, int top, int right, int bottom) {
        LayoutParams lp = (LayoutParams) view.getVLayoutParams();
        if (lp.alignSelf != ALIGN_SELF_AUTO) {
            // Expecting the values for alignItems and alignSelf match except for ALIGN_SELF_AUTO.
        ...
        switch (alignItems) {
            ...
            case ALIGN_ITEMS_BASELINE:
                if (!isRtl) {
                    view.vLayout(left + lp.leftMargin, top, right + lp.leftMargin, bottom);
                } else {
                    view.vLayout(left - lp.rightMargin, top, right - lp.rightMargin, bottom);
                }
                break;
            case ALIGN_ITEMS_FLEX_END:
                if (!isRtl) {
                    view.vLayout(left + crossSize - view.getVMeasuredWidth() - lp.rightMargin,
                            top, right + crossSize - view.getVMeasuredWidth() - lp.rightMargin,
                            bottom);
                } else {
                    // If the flexWrap == FLEX_WRAP_WRAP_REVERSE, the direction of the
                    // flexEnd is flipped (from left to right).
                    view.vLayout(left - crossSize + view.getVMeasuredWidth() + lp.leftMargin, top,
                            right - crossSize + view.getVMeasuredWidth() + lp.leftMargin,
                            bottom);
                }
                break;
            case ALIGN_ITEMS_CENTER:
                int leftFromCrossAxis = (crossSize - view.getVMeasuredWidth()
                        + MarginLayoutParamsCompat.getMarginStart(lp)
                        - MarginLayoutParamsCompat.getMarginEnd(lp)) / 2;
                if (!isRtl) {
                    view.vLayout(left + leftFromCrossAxis, top, right + leftFromCrossAxis, bottom);
                } else {
                    view.vLayout(left - leftFromCrossAxis, top, right - leftFromCrossAxis, bottom);
                }
                break;
    ...
    private boolean allViewsAreGoneBefore(int childAbsoluteIndex,
        ...
        for (int i = 1; i <= childRelativeIndexInFlexLine; i++) {
            IView view = getReorderedChildAt(childAbsoluteIndex - i);
