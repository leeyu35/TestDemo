...
public class LinearLayout extends android.widget.LinearLayout implements ILayout {
    private final static String TAG = "LinearLayout";
    ...
    public static class Builder implements IBuilder {
        ...
        public IView build(PageContext pageContext, ViewCache viewCache) {
            return new LinearLayout(pageContext, viewCache);
        }
    }

    public LinearLayout(PageContext pageContext, ViewCache viewCache) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mId == mPageContext.getStringTab().getStringId("root")) {
            Utils.sleep();
        }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams implements IAttr {
        ...
        public boolean setIntValue(int key, int value) {
            ...
            switch (key) {
                ...
                case StringTab.STR_ID_layout_weight:
                    weight = value;
                    break;
